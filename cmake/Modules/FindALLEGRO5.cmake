...
#Corbit dev here, changed both of set(VERSION_NUMBER "5.x") to "5" because that's what it's like
set(VERSION_NUMBER "5")

if(UNIX AND NOT CYGWIN)
	exec_program(pkg-config ARGS "allegro-${VERSION_NUMBER} allegro_ttf-${VERSION_NUMBER} allegro_memfile-${VERSION_NUMBER} allegro_image-${VERSION_NUMBER} allegro_primitives-${VERSION_NUMBER} allegro_audio-${VERSION_NUMBER} allegro_acodec-${VERSION_NUMBER} --libs --cflags" OUTPUT_VARIABLE ALLEGRO_LIBRARY)
